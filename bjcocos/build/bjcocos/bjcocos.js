...
__jah__.resources["/mainLayer.js"] = {data: function (exports, require, module, __filename, __dirname) {
"use strict"  // Use strict JavaScript mode
...
function Bjcocos () {
    // You must always call the super class constructor
    Bjcocos.superclass.constructor.call(this)
    ...
    // Create label
    var label = new Label({ string:   'Bjcocos'
                          , fontName: 'Arial'
                          , fontSize: 76
                          })
...
// Inherit from cocos.nodes.Layer
Bjcocos.inherit(Layer)

module.exports = Bjcocos

}, mimetype: "application/javascript", remote: false}; // END: /mainLayer.js
